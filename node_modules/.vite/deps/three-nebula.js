...
var Util_default = {
  ...
  setVectorByObj: function(target, pOBJ) {
    if (pOBJ["x"] !== void 0) target.position.x = pOBJ["x"];
    if (pOBJ["y"] !== void 0) target.position.y = pOBJ["y"];
    if (pOBJ["z"] !== void 0) target.position.z = pOBJ["z"];
    if (pOBJ["vx"] !== void 0) target.velocity.x = pOBJ["vx"];
    if (pOBJ["vy"] !== void 0) target.velocity.y = pOBJ["vy"];
    if (pOBJ["vz"] !== void 0) target.velocity.z = pOBJ["vz"];
    if (pOBJ["ax"] !== void 0) target.acceleration.x = pOBJ["ax"];
    if (pOBJ["ay"] !== void 0) target.acceleration.y = pOBJ["ay"];
    if (pOBJ["az"] !== void 0) target.acceleration.z = pOBJ["az"];
    if (pOBJ["p"] !== void 0) target.position.copy(pOBJ["p"]);
    if (pOBJ["v"] !== void 0) target.velocity.copy(pOBJ["v"]);
    if (pOBJ["a"] !== void 0) target.acceleration.copy(pOBJ["a"]);
    if (pOBJ["position"] !== void 0) target.position.copy(pOBJ["position"]);
    if (pOBJ["velocity"] !== void 0) target.velocity.copy(pOBJ["velocity"]);
    if (pOBJ["accelerate"] !== void 0) target.acceleration.copy(pOBJ["accelerate"]);
  },
  //set prototype
...
var Span = class {
  ...
  getValue(INT) {
    if (this._isArray) {
      ...
      if (!this._center) return MathUtils_default.randomAToB(this.a, this.b, INT);
      else return MathUtils_default.randomFloating(this.a, this.b, INT);
    }
  }
};
var createSpan = (a, b, c) => {
  ...
  if (b === void 0) {
    ...
    if (c === void 0) return new Span(a, b);
...
var Pool = class {
  ...
  _getList(uid2) {
    uid2 = uid2 || "default";
    if (!this.list[uid2]) this.list[uid2] = [];
    ...
    return function(style) {
      ...
      if (!this._infoCon) {
        ...
        this._infoCon.addEventListener("click", function() {
          self2._infoType++;
          if (self2._infoType > 3) self2._infoType = 1;
        }, false);
        var bg, color;
        switch (style) {
          case 2:
